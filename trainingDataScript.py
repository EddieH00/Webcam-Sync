            ...
            while(1):
                ...
                with renderer.frame_condition:
                    if renderer.frame_condition.wait(150.0 / 1000.0):
                        ...
                        capTime = time.time_ns
                        imgName = str(capTime) +'.jpg'
                        file = open(currentFolder + '/' + scenerios[scenerioNumber-1][scene] + '/seek_temperatures/' + str(capTime) + '.csv', 'w')
                        ...
                        cv2.imwrite(currentFolder + '/' + scenerios[scenerioNumber-1][scene] + '/seek_jpg/' + imgName, imgt_rescaled)
