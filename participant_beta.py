...
scenerios = ['enter simulator', 'driving']
    ...
    for i in range(len(scenerios)):
        ...
        while webcam.isOpened():
            ...
            if ret is True:
                ...
                cv2.imwrite(subfolder + '/webcam' + str(webcamNumber+1) + '/' + imgName, frame)
            ...
            while(1):
                ...
                with renderer.frame_condition:
                    if renderer.frame_condition.wait(150.0 / 1000.0):
                        ...
                        capTime = time.time_ns()
                        imgName = str(capTime) +'.jpg'
                        file = open(currentFolder + '/' + scenerios[scene] + '/seek_temperatures/' + str(capTime) + '.csv', 'w')
                        ...
                        cv2.imwrite(currentFolder + '/' + scenerios[scene] + '/seek_jpg/' + imgName, imgt_rescaled)
